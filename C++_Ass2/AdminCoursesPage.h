#pragma once
#include "AdminAddCourse.h"
#include "AdminModifyCourse.h"
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(AdminCoursesPage::typeid));
			...
			this->button5->Click += gcnew System::EventHandler(this, &AdminCoursesPage::button5_Click);
			// 
			// button4
			// 
			...
			this->button4->Text = L"Modify Course";
			this->button4->UseVisualStyleBackColor = false;
			this->button4->Click += gcnew System::EventHandler(this, &AdminCoursesPage::button4_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &AdminCoursesPage::button3_Click);
			// 
			// button2
			// 
			...
			this->Name = L"AdminCoursesPage";
			this->Text = L"AdminCoursesPage";
