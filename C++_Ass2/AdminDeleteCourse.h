...
namespace CAss2 {
	...
	/// </summary>
	public ref class AdminDeleteCourse : public System::Windows::Forms::Form
	{
	public:
		AdminDeleteCourse(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Location = System::Drawing::Point(136, 19);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(251, 39);
			this->label2->TabIndex = 7;
			this->label2->Text = L"Delete Course";
			// 
			// panel1
			// 
			...
			this->Name = L"AdminDeleteCourse";
			this->Text = L"AdminDeleteCourse";
