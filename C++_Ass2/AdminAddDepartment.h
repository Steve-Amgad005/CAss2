...
namespace CAss2 {
	...
	/// </summary>
	public ref class AdminAddDepartment : public System::Windows::Forms::Form
	{
	public:
		AdminAddDepartment(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Location = System::Drawing::Point(113, 34);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(283, 39);
			this->label2->TabIndex = 3;
			this->label2->Text = L"Add Department";
			// 
			// panel1
			// 
			...
			this->Text = L"AdminAddDepartment";
