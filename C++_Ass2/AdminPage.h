...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Click += gcnew System::EventHandler(this, &AdminPage::label1_Click);
			// 
			// pictureBox1
			// 
			...
			this->pictureBox1->Click += gcnew System::EventHandler(this, &AdminPage::pictureBox1_Click);
			// 
			// button1
			// 
			...
			this->button1->Location = System::Drawing::Point(1144, 28);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(72, 75);
			...
			this->button2->Text = L"Year\'s Marks";
			...
			// button9
			// 
			this->button9->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(64)), static_cast<System::Int32>(static_cast<System::Byte>(0)),
				static_cast<System::Int32>(static_cast<System::Byte>(64)));
			...
			this->button9->Text = L"Assistants";
