...
#include "AdminAddHall.h"
#include "AdminModifyHall.h"
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button4->Text = L"Modify Hall";
			this->button4->UseVisualStyleBackColor = false;
			this->button4->Click += gcnew System::EventHandler(this, &AdminHallsPage::button4_Click);
			// 
			// button3
			// 
			...
			this->button3->Text = L"Delete Hall";
			this->button3->UseVisualStyleBackColor = false;
			this->button3->Click += gcnew System::EventHandler(this, &AdminHallsPage::button3_Click);
			// 
			// button2
			// 
			...
			this->button5->Text = L"Add Hall";
			this->button5->UseVisualStyleBackColor = false;
			this->button5->Click += gcnew System::EventHandler(this, &AdminHallsPage::button5_Click);
			// 
			// panel1
			// 
