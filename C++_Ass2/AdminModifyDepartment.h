...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Size = System::Drawing::Size(328, 39);
			this->label2->TabIndex = 5;
			this->label2->Text = L"Modify Department";
			// 
			// panel1
			// 
			...
			this->ClientSize = System::Drawing::Size(508, 385);
			this->Controls->Add(this->label2);
			this->Controls->Add(this->panel1);
			this->Name = L"AdminModifyDepartment";
			this->Text = L"AdminModifyDepartment";
