...
namespace CAss2 {
	...
	/// </summary>
	public ref class AdminDeleteHall : public System::Windows::Forms::Form
	{
	public:
		AdminDeleteHall(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Location = System::Drawing::Point(152, 22);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(197, 39);
			this->label2->TabIndex = 11;
			this->label2->Text = L"Delete Hall";
			// 
			// AdminDeleteHall
			// 
			...
			this->Name = L"AdminDeleteHall";
			this->Text = L"AdminDeleteHall";
