...
namespace CAss2 {
	...
	/// <summary>
	/// Summary for BuildingsPage
	/// </summary>
	public ref class BuildingsPage : public System::Windows::Forms::Form
	{
	public:
		BuildingsPage(void)
		{
	...
	private: System::Windows::Forms::DataGridViewTextBoxColumn^ FloorsNumbers;
	private: System::Windows::Forms::DataGridViewTextBoxColumn^ HallsNumbers;
	private: System::Windows::Forms::DataGridViewTextBoxColumn^ LabsNumbers;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(BuildingsPage::typeid));
			this->dataGridView1 = (gcnew System::Windows::Forms::DataGridView());
			this->BuildingID = (gcnew System::Windows::Forms::DataGridViewTextBoxColumn());
			this->BuildingName = (gcnew System::Windows::Forms::DataGridViewTextBoxColumn());
			this->FloorsNumbers = (gcnew System::Windows::Forms::DataGridViewTextBoxColumn());
			this->HallsNumbers = (gcnew System::Windows::Forms::DataGridViewTextBoxColumn());
			this->LabsNumbers = (gcnew System::Windows::Forms::DataGridViewTextBoxColumn());
			...
			this->dataGridView1->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(5) {
				this->BuildingID,
					this->BuildingName, this->FloorsNumbers, this->HallsNumbers, this->LabsNumbers
			});
			this->dataGridView1->Location = System::Drawing::Point(467, 169);
			this->dataGridView1->Name = L"dataGridView1";
			dataGridViewCellStyle3->BackColor = System::Drawing::Color::White;
			this->dataGridView1->RowsDefaultCellStyle = dataGridViewCellStyle3;
			this->dataGridView1->Size = System::Drawing::Size(540, 373);
			...
			// BuildingName
			// 
			this->BuildingName->HeaderText = L"Building Name";
			this->BuildingName->Name = L"BuildingName";
			// 
			// FloorsNumbers
			// 
			this->FloorsNumbers->HeaderText = L"Number of Floor";
			this->FloorsNumbers->Name = L"FloorsNumbers";
			// 
			// HallsNumbers
			// 
			this->HallsNumbers->HeaderText = L"Number of Halls";
			this->HallsNumbers->Name = L"HallsNumbers";
			// 
			// LabsNumbers
			// 
			this->LabsNumbers->HeaderText = L"Number of Labs";
			this->LabsNumbers->Name = L"LabsNumbers";
			// 
			// button5
			// 
			...
			this->button5->Location = System::Drawing::Point(104, 169);
			...
			this->button4->Location = System::Drawing::Point(104, 270);
			...
			this->button3->Location = System::Drawing::Point(104, 371);
			...
			this->button2->Location = System::Drawing::Point(104, 465);
			...
			this->button6->Location = System::Drawing::Point(1136, 50);
			...
			this->Name = L"BuildingsPage";
			this->Text = L"BuildingsPage";
			this->Load += gcnew System::EventHandler(this, &BuildingsPage::BuildingsPage_Load);
...
#pragma endregion
	private: System::Void BuildingsPage_Load(System::Object^ sender, System::EventArgs^ e) {
	}
