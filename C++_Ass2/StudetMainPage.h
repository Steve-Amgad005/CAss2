...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(380, 31);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(429, 39);
			this->label1->TabIndex = 0;
			this->label1->Text = L"جامعة القاهرة الجديدة التكنولوجية";
			this->label1->Click += gcnew System::EventHandler(this, &StudetMainPage::label1_Click);
			// 
			// pictureBox1
			// 
			this->pictureBox1->BackgroundImage = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"pictureBox1.BackgroundImage")));
			this->pictureBox1->BackgroundImageLayout = System::Windows::Forms::ImageLayout::Stretch;
			this->pictureBox1->Location = System::Drawing::Point(1029, 20);
			...
			this->button3->Text = L"Seat Number";
			...
			this->button4->Text = L"Seat Number";
