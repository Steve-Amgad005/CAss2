...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Location = System::Drawing::Point(91, 16);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(325, 39);
			this->label2->TabIndex = 7;
			this->label2->Text = L"Delete Department";
			this->label2->Click += gcnew System::EventHandler(this, &AdminDeleteDepartment::label2_Click);
			// 
			// panel1
			// 
			...
			this->panel1->Size = System::Drawing::Size(429, 170);
			...
			this->button2->Location = System::Drawing::Point(92, 97);
			...
			this->ClientSize = System::Drawing::Size(503, 380);
			this->Controls->Add(this->label2);
			this->Controls->Add(this->panel1);
			this->Name = L"AdminDeleteDepartment";
			this->Text = L"AdminDeleteDepartment";
